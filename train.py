...
window.title("Attendance Based Face Recognition System")
...
message = tk.Label(window, text="Attendance Based Face Recognition System" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('Helvetica', 30, 'bold underline'))
...
copyWrite.insert("insert", "Developed by PANKAJ & RUTANJALI")#,"", "TEAM", "superscript")
